...
This script will iterate over all open files in inventor, and exports
any open parts as STEP files.
"""
...
for i in range(1, docs.Count+1):
    ...
    if doc.DocumentType == constants.kPartDocumentObject:
        # Export parts as STEP files.
        outname = '.'.join(filename.split('.')[0:-1] + ['step'])
